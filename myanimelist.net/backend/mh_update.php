<?php
	...
	if(empty($_POST['userid']) || empty($_POST['db_id']) || empty($_POST['type']) || empty($_POST['title']) || empty($_POST['status']) || empty($_POST['score']) || empty($_POST['addup'])) die('Missing Parameter(s).');
	...
	if($type == 'anime'){
		if(empty($_POST['ep_watched']) || empty($_POST['ep_count'])) die('Missing Parameter(s).');
	...
	elseif($type == 'manga'){
		if(empty($_POST['ch_read']) || empty($_POST['ch_count']) || empty($_POST['vol_read']) || empty($_POST['vol_count'])) die('Missing Parameter(s).');
